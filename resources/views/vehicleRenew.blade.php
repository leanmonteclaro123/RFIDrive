                ...
                <div class="form-content" id="vehicle-sections">
                    ...
                    <div class="card shadow-sm mb-4 p-3 vehicle-section" id="vehicle-section-1">
                        ...
                        <div class="form-group">
                            ...
                            <input name="vehicles[0][license_plate]" type="text" id="license-plate-number-1" class="form-control" required placeholder="Enter License Plate No." autocomplete="off">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="two-box form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="vehicles[0][make]" type="text" id="make-1" class="form-control" required placeholder="Enter Make" autocomplete="off">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="model-1">Model <span class="text-danger">*</span>:</label>
                                <input name="vehicles[0][model]" type="text" id="model-1" class="form-control" required placeholder="Enter Model" autocomplete="off">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="year-1">Year <span class="text-danger">*</span>:</label>
                                <input name="vehicles[0][year]" type="text" id="year-1" class="form-control" required placeholder="Enter Year" autocomplete="off">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="color-1">Color <span class="text-danger">*</span>:</label>
                                <input name="vehicles[0][color]" type="text" id="color-1" class="form-control" required placeholder="Enter Color" autocomplete="off">
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="registered-owner-name-1">Registered Owner's Name <span class="text-danger">*</span>:</label>
                            <input name="vehicles[0][registered_owner_name]" type="text" id="registered-owner-name-1" class="form-control" required placeholder="Enter Registered Owner's Name" autocomplete="off">
                        </div>
                    ...
                    <div class="card shadow-sm mb-4 p-3 vehicle-section" id="vehicle-section-2" style="display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <input name="vehicles[1][license_plate]" type="text" id="license-plate-number-2" class="form-control" placeholder="Enter License Plate No." autocomplete="off">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="two-box form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="vehicles[1][make]" type="text" id="make-2" class="form-control" placeholder="Enter Make" autocomplete="off">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="model-2">Model <span class="text-danger">*</span>:</label>
                                <input name="vehicles[1][model]" type="text" id="model-2" class="form-control" placeholder="Enter Model" autocomplete="off">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="year-2">Year <span class="text-danger">*</span>:</label>
                                <input name="vehicles[1][year]" type="text" id="year-2" class="form-control" placeholder="Enter Year" autocomplete="off">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="color-2">Color <span class="text-danger">*</span>:</label>
                                <input name="vehicles[1][color]" type="text" id="color-2" class="form-control" placeholder="Enter Color" autocomplete="off">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="registered-owner-name-2">Registered Owner's Name <span class="text-danger">*</span>:</label>
                            <input name="vehicles[1][registered_owner_name]" type="text" id="registered-owner-name-2" class="form-control" required placeholder="Enter Registered Owner's Name" autocomplete="off">
                        </div>
